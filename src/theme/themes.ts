...
const glassWhite: ThemeConfig = {
  ...
  colors: {
    ...
    accent: { light: '#4DD0E1', main: '#0097A7', dark: '#00838F' },
    glass: {
      white: 'rgba(255,255,255,0.72)', whiteMedium: 'rgba(255,255,255,0.82)',
      whiteStrong: 'rgba(255,255,255,0.92)', whiteSolid: 'rgba(255,255,255,0.97)',
      dark: 'rgba(0,0,0,0.04)', darkMedium: 'rgba(0,0,0,0.08)',
      tint: 'rgba(0,151,167,0.08)', tintMedium: 'rgba(0,151,167,0.15)', tintStrong: 'rgba(0,151,167,0.25)',
      border: 'rgba(0,0,0,0.08)', borderLight: 'rgba(0,0,0,0.05)',
    },
    gradient: {
      primary: ['#BCC5D3', '#C8CFD9', '#D5DAE1'] as const,
      light: ['#F0F2F5', '#E8EAF0', '#E0E3E9'] as const,
      accent: ['#00838F', '#0097A7', '#4DD0E1'] as const,
    },
    ...
    text: {
      primary: '#1A1A2E', secondary: 'rgba(26,26,46,0.70)', tertiary: 'rgba(26,26,46,0.50)',
      dark: '#1A1A2E', darkSecondary: '#37374D', onGlass: '#1A1A2E', onLight: '#1A1A2E',
    },
    background: {
      primary: '#C8CFD9', secondary: '#E8EAF0',
      card: 'rgba(255,255,255,0.75)', input: 'rgba(255,255,255,0.85)',
    },
    white: '#FFFFFF', black: '#000000', transparent: 'transparent',
    tabBar: { background: 'rgba(255,255,255,0.92)', active: '#00838F', inactive: 'rgba(26,26,46,0.40)' },
    blurTint: 'default',
  },
};
